...
def objective_function(x):
    ...
    obj_function_res = passenger_total_time + fixed_cost + flexible_cost
    print("目标函数" )
...
ga = GA(func=objective_function, n_dim=155, size_pop=size_pop, max_iter=max_iter,
        ...
        precision=[1] * 155, prob_mut=1)

# 创建进度条
with tqdm(total=max_iter, desc="GA Iterations") as pbar:
    for _ in range(max_iter):
        ...
        # 更新进度条
        pbar.update(1)
        pbar.set_postfix(best_fitness=best_y)
