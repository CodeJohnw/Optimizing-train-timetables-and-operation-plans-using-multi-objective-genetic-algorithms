...
def plot_train_schedule(departure_time, start_station, end_station, dwell_time):
    """
    绘制列车的时间-距离曲线，显示列车从一个起始站到终点站的运行情况。
    ...
    plt.plot(plot_time, plot_distance, linestyle='-', label='Train Schedule', marker=None, linewidth=0.5)
...
# 调用绘图函数，传递列车的出发时间、起始站、终点站和停车时间
plot_train_schedule(1800, 5, 23, [120] * 30)
